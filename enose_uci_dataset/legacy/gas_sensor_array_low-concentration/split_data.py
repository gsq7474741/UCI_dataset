...
def read_label(csv_path: str) -> int:
    # label_gas is constant per file; read the first row
    df = pd.read_csv(csv_path, usecols=["label_gas"], nrows=1)
...
def main():
    ...
    print(f"Stratified split done. Saved to {SPLITS_PATH}")
